...
return new class extends Migration
{
    ...
    {
        Schema::create('newsystem_inventory_registrations', function (Blueprint $table) {
            $table->id();
            $table->bigInteger('inventoryRegistrationID');
            $table->bigInteger('inventoryRegistrationNo');
    ...
    {
        Schema::dropIfExists('newsystem_inventory_registrations');
    }
};
