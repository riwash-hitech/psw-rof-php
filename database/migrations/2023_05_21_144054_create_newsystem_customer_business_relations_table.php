...
return new class extends Migration
{
    ...
    {
        Schema::connection("mysql2")->create('newsystem_customer_business_relations', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('newsystem_customer_business_relations');
    }
};
